...
function Home() {
  const TurnosList = [
    {Id: 1, Cliente: "cliente1", Turno: 3}, 
    {Id: 2, Cliente: "cliente2", Turno: 2},
    {Id: 3, Cliente: "cliente3", Turno: 4},
    {Id: 4, Cliente: "cliente4", Turno: 5},
    {Id: 5, Cliente: "cliente5", Turno: 1}
  ]
    ...
    <div className='app'>
      <div className='conteiner'>
        <div className='menu'>
          ...
          <Link className="link" to={"/inicio"}><h3>[-Inicio]</h3></Link>
          <Link className="link"  to={"/consulta-turno"}><h3>[-Consulta turnos]</h3></Link>
          <Link className="link"  to={"/nuevo-turno"}><h3>[-Nuevo Turno]</h3></Link>
        </div>
        <div className='inf'>
          <h2>DASHBOARD</h2>
          <h3>Cantidad de Turnos por clientes:</h3>
          {
            TurnosList.map(t => {return (<div key={t.Id}><p>{t.Cliente}{" | Turnos: "}{t.Turno}</p></div>)})
          }
        </div>
      </div>
      <div className='pie'>
        <p>@2024 [Pie de pagina]</p>
      </div>
    </div>
  );
}
